...
internal static class Program
{
    ...
    private static bool _clientRunning;
    ...
    static async Task Main(string[] args)
    {
        ...
        await _tcpClient.ConnectAsync(remoteEndpoint.Address, remoteEndpoint.Port);
        Console.WriteLine("Connected to server!!!!");
        _clientRunning = true;

        _networkDataHelper = new NetworkDataHelper(_tcpClient);
                ...
                else
                {
                    ...
                    switch (option)
                    {
                        ...
                        case "4":
                            ...
                            break;
                        case "5":
                            await PublishGame(_tcpClient);
                            break;
                        case "6":
                            await ModifyGame(_tcpClient);
                            break;
                        case "7":
                            await DeleteGame();
                            break;
